# Zenodo Form Values - SCILLA PASSIVE v1.0.0
...
Optional affiliation: `Giletto Systems Lab` (use only if you want it shown in the citation metadata).
...
**License**  
Do not leave Zenodo's default CC BY 4.0 if you want proprietary reuse restrictions. Use **Add custom** and enter:
...
**File to upload**  
Upload the single final ZIP archive `SCILLA_PASSIVE_PUBLIC_EVIDENCE_RELEASE_v1.0.0_2026-09-01.zip`.

**Do not publish until**  
1. the final ZIP has uploaded successfully;  
2. Zenodo preview shows DOI `10.5281/zenodo.22229086`;  
3. creator/title/version/date are correct;  
4. the custom rights/license is correct;  
5. no RC1 archive is attached.
